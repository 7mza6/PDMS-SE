...
import PDMS.application.form.LoginForm;
import PDMS.menu.mode.LightDarkMode;
...
import PDMS.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    public void setMenuItems(char x) {
         if (x == 'A'){
            menuItems = new String[][] {
             ...
             {"Branch"},
             {"~Users Management~"},
             {"Users","All Employee","Staff","Delevery Staff"},
             {"Logout"}
        };
    } else if (x == 'S') {
        menuItems = new String[][] {
    ...
    public  List<MenuEvent> events = new ArrayList<>();
    private boolean menuFull = true;
    private final String headerName = "PDMS";
    ...
    public void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/PDMS/icon/png/logo.png")));
