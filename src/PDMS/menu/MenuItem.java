...
public class MenuItem extends JPanel {
    ...
    private Icon getIcon() {
        ...
        if(x=='A'){
         ...
         icon = new FlatSVGIcon("PDMS/menu/icon/Admin/" + (menuIndex +1) +".svg");
        
        }
        else if(x=='D'){
        
         icon = new FlatSVGIcon("PDMS/menu/icon/Delivery/" + menuIndex + ".svg");
        
        }
        else{
            icon = new FlatSVGIcon("PDMS/menu/icon/Staff/" + (menuIndex +1) +".svg");
        }
